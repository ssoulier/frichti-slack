...
if __name__ == '__main__':
    event = {'resource': '/frichti', 'path': '/frichti', 'httpMethod': 'POST',
             'headers': {'Accept': 'application/json,*/*', 'Accept-Encoding': 'gzip,deflate',
                         ...
                         'Host': 'cwpc4sd08l.execute-api.us-east-1.amazonaws.com',
                         'User-Agent': 'Slackbot 1.0 (+https://api.slack.com/robots)',
                         'Via': '1.1 78ae32a88b9156d6c12be8f261f1c1b8.cloudfront.net (CloudFront)',
                         'X-Amz-Cf-Id': 'PJCM62crYbWZYFIhdy-q_OLUC4Ypi1L4WrJ6sWcWNnxpmpkThsg_VA==',
                         'X-Amzn-Trace-Id': 'Root=1-5b426d8c-17355f75e36a8a980455658e',
                         'X-Forwarded-For': '52.71.192.87, 54.182.230.66', 'X-Forwarded-Port': '443',
                         'X-Forwarded-Proto': 'https', 'X-Slack-Request-Timestamp': '1531080076',
                         'X-Slack-Signature': 'v0=018d0453b72947387b0eb1cc7d76b8004b048d1d9fe83d6f04b8f3fa50e61bf8'},
             'queryStringParameters': None, 'pathParameters': None, 'stageVariables': None,
             'requestContext': {'resourceId': '1n9979', 'resourcePath': '/frichti', 'httpMethod': 'POST',
                                'extendedRequestId': 'JuYOAH5WoAMFpHQ=', 'requestTime': '08/Jul/2018:20:01:16 +0000',
                                'path': '/dev/frichti', 'accountId': '483879061606', 'protocol': 'HTTP/1.1',
                                'stage': 'dev', 'requestTimeEpoch': 1531080076830,
                                'requestId': 'ac868cef-82e9-11e8-ad92-cb54d0a9fa39',
                                'identity': {'cognitoIdentityPoolId': None, 'accountId': None,
                                             'cognitoIdentityId': None, 'caller': None, 'sourceIp': '52.71.192.87',
